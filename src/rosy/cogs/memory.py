...
class Memory(commands.Cog):
    ...
    async def remember(self, interaction: discord.Interaction, content: str) -> None:
        ...
        await interaction.followup.send("I've remembered that. 🧠", ephemeral=True)
    ...
    async def show(self, interaction: discord.Interaction) -> None:
        ...
        if not memories:
            await interaction.followup.send("I don't have any memories here yet.", ephemeral=True)
            return
    ...
    async def clear(self, interaction: discord.Interaction) -> None:
        ...
        await interaction.followup.send(f"Cleared {n} memories.", ephemeral=True)
